<template>
    <div>
        ...
        <!--Secretary -->
        <h4>Secretary:</h4>
        <p v-show="dataItem !== 'secretary' || editmode=='r'" @click="startSecretaryEdit">{{ choices.users[meeting.secretary_id].full_name }}</p>
        <div v-show="dataItem === 'secretary' && editmode">
            ...
            <button @click="saveSecretaryEdit">Save</button>
