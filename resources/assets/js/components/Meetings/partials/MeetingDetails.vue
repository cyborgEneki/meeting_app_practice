  ...
  <div class="padding-15">
    ...
    <div v-show="dataItem === 'name'">
      ...
      <el-button
        ...
        type="success"
        circle
        @click.prevent="saveMeetingFieldEdit('name')"
      >Save</el-button>
    ...
    <div v-show="dataItem === 'date'">
      <input
        v-validate="'after:'+refDate+'|date_format:YYYY-MM-DD'"
        name="after_field"
        type="text"
        placeholder="yyyy-mm-dd"
        v-model="dataHolder.date"
      >
      ...
      <el-button
        ...
        type="success"
        circle
        @click.prevent="saveMeetingFieldEdit('date')"
      >Save</el-button>
      <a href="#" class="same-line" @click.prevent="dataItem=''">Cancel</a>
    </div>
    ...
    <div v-show="dataItem === 'start_time'">
      ...
      <el-button
        ...
        type="success"
        circle
        @click.prevent="saveMeetingFieldEdit('start_time')"
      >Save</el-button>
      <a href="#" class="same-line" @click.prevent="dataItem=''">Cancel</a>
    </div>
    ...
    <div v-show="dataItem === 'end_time'">
      <input
        v-validate="'after:'+meeting.start_time+'|required'"
        name="end_time"
        v-model="dataHolder.end_time"
        type="time"
      >
      ...
      <el-button
        ...
        type="success"
        circle
        @click.prevent="saveMeetingFieldEdit('end_time')"
      >Save</el-button>
      <a href="#" class="same-line" @click.prevent="dataItem=''">Cancel</a>
    </div>
    ...
    <div v-show="dataItem === 'creator_id'">
      ...
      <el-button
        ...
        type="success"
        circle
        @click.prevent="saveMeetingFieldEdit('creator_id')"
      >Save</el-button>
      <a href="#" class="same-line" @click.prevent="dataItem=''">Cancel</a>
    </div>
    ...
    <div v-show="dataItem === 'chair_id'">
      ...
      <el-button
        ...
        type="success"
        circle
        @click.prevent="saveMeetingFieldEdit('chair_id')"
      >Save</el-button>
      <a href="#" class="same-line" @click.prevent="dataItem=''">Cancel</a>
    </div>
    ...
    <div v-show="dataItem === 'secretary_id'">
      ...
      <el-button
        ...
        type="success"
        circle
        @click.prevent="saveMeetingFieldEdit('secretary_id')"
      >Save</el-button>
      <a href="#" class="same-line" @click.prevent="dataItem=''">Cancel</a>
    </div>
    ...
    <br>
    <div>
      <div v-for="(agenda, index) in meeting.agendas" v-bind:key="agenda.id">
        <fieldset>
          <div>
            ...
            <div>
              <div v-show="dataItem !== 'agendaEdit'+ agenda.id">
                <div @click.prevent="!meeting.locked && startAgendaEdit(agenda.id)">
                  ...
                  <div v-if="agenda.time_allocated">
                    Time Allocated (minutes) {{ agenda.time_allocated
                    }}
                  </div>
                ...
                <div v-show="!meeting.locked">
                  <a
                    ...
                    @click.prevent="(!agenda.vote || !agenda.vote.vote) && voteAgenda(1, agenda.id)"
                  >Up</a>
                  
                  <a
                    href="#"
                    :class="{disabled: agenda.vote && !agenda.vote.vote}"
                    @click.prevent="(!agenda.vote || agenda.vote.vote) && voteAgenda(0, agenda.id)"
                  >Down</a>
                  
                  <a
                    href="#"
                    v-show="agenda.vote"
                    @click.prevent="voteAgenda(null, agenda.id, true)"
                  >Abstain</a>
                </div>
                ...
                <div>
                  ...
                  <div v-show="dataItem === 'followupCreate'+agenda.id">
                    Action *
                    <input type="text" v-model="dataHolder.action">
                    Timeline *
                    <input type="text" v-model="dataHolder.timeline">
                    Status *
                    ...
                    <button
                      ...
                      @click.prevent="saveFollowup(agenda.id)"
                    >Save</button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div v-show="dataItem === 'discussionCreate'+agenda.id">
                    ...
                    <button
                      ...
                      @click.prevent="saveDiscussion(agenda.id)"
                    >Save</button>
                  </div>
                </div>
            ...
            <form @click.prevent>
              ...
              >
                ...
                <div>
                  Conclusion
                  <input type="text" v-model="dataHolder.conclusion">
                </div>
                <div>
                  <el-button
                    class="same-line"
                    ...
                    icon="el-icon-check"
                    circle
                    @click.prevent="saveAgendaEdit(agenda.id)"
                  >Save Edit</el-button>
                </div>
                <div class="same-line">
    ...
    <div v-show="dataItem === 'venue_id'">
      ...
      <el-button
        ...
        type="success"
        circle
        @click.prevent="saveMeetingFieldEdit('venue_id')"
      >Save</el-button>
      <a href="#" class="same-line" @click.prevent="dataItem=''">Cancel</a>
    </div>
    ...
    <div v-show="dataItem === 'media_id'">
      ...
      <el-button
        ...
        type="success"
        circle
        @click.prevent="saveMeetingFieldEdit('media_id')"
      >Save</el-button>
      <a href="#" class="same-line" @click.prevent="dataItem=''">Cancel</a>
    </div>
    ...
    <div v-show="dataItem === 'meetingtype_id'">
      <select v-model="dataHolder.meetingtype_id">
        ...
        <option
          v-for="meetingtype in orderedMeetingTypes"
          :value="meetingtype.id"
        >{{ meetingtype.name }}</option>
      </select>
      <el-button
        class="same-line"
        icon="el-icon-check"
        type="success"
        circle
        @click.prevent="saveMeetingFieldEdit('meetingtype_id')"
      >Save</el-button>
      <a href="#" class="same-line" @click.prevent="dataItem=''">Cancel</a>
    </div>
...
export default {
  ...
  methods: {
    ...
    saveAgendaRelation() {
      this.dataHolder.action = "relate";
      axios.post("/api/agendas/relate", this.dataHolder).then(response => {
        this.dataItem = "";
        //get the index of the source agenda (agenda you are linking from)
        var agendaIndex = this.meeting.agendas
          .map(function(item) {
            return item.id;
          })
          .indexOf(this.dataHolder.agendasource_id);
        //update the list in the agenda you are working on (source)
        this.meeting.agendas[agendaIndex].related_agendas.push(
          this.dataHolder.agendatarget_id
        );

        //add to list of agenda linked to (target)
        var agendaIndex = this.meeting.agendas
          .map(function(item) {
            return item.id;
          })
          .indexOf(this.dataHolder.agendatarget_id);
        //if agenda linked to is in this meeting, update it. Ideally we would update regardless
        if (agendaIndex !== -1) {
          this.meeting.agendas[agendaIndex].related_agendas.push(
            this.dataHolder.agendasource_id
          );
        }
        this.dataHolder = {};
      });
    },
    deleteAgendaRelation(sourceId, targetId) {
      //set up data to send
      this.dataHolder.agendasource_id = sourceId;
      this.dataHolder.agendatarget_id = targetId;
      this.dataHolder.action = "unrelate";
      axios.post("/api/agendas/relate", this.dataHolder).then(response => {
        this.dataHolder = {};
        //remove from current agenda
        var agendaIndex = this.meeting.agendas
          .map(function(item) {
            return item.id;
          })
          .indexOf(sourceId);
        var relAgendaIndex = this.meeting.agendas[agendaIndex].related_agendas
          .map(function(item) {
            return item.id;
          })
          .indexOf(targetId);
        this.meeting.agendas[agendaIndex].related_agendas.splice(
          relAgendaIndex,
          1
        );

        //delete from related agenda (target) in current meeting
        var agendaIndex = this.meeting.agendas
          .map(function(item) {
            return item.id;
          })
    ...
    voteAgenda(thevote, agendaId, abstain = false) {
      axios
        .post("api/agendas/vote", {
          agenda_id: agendaId,
          vote: thevote,
          abstain: abstain
        })
        .then(response => {
          let agendaIndex = this.meeting.agendas
            .map(function(item) {
              return item.id;
            })
            .indexOf(agendaId);
    ...
    isAgendaRelationComplete() {
      return this.dataHolder.agendatarget_id;
    },
    startVoting() {
    ...
    saveMeetingFieldEdit(theField) {
      axios
        .put("api/meetings/" + this.meeting.id, this.dataHolder)
        .then(response => {
          ...
          if (theField === "secretary_id") {
            /*
                              ...
                              */
            let userIndex = this.meeting.users
              .map(function(user) {
                return user.id;
              })
            ...
            if (userIndex === -1) {
              axios
                .post("api/meetings/attachuser", {
                  meeting_id: this.meeting.id,
                  user_id: this.dataHolder.secretary_id
                })
                .then(
                  this.meeting.users.push(
                    this.choices.users[this.dataHolder.secretary_id]
                  )
                );
            }
          }
          ...
          if (theField === "chair_id") {
            ...
            if (userIndex === -1) {
              axios
                ...
                .then(
                  this.meeting.users.push(
                    this.choices.users[this.dataHolder.chair_id]
                  )
                );
            }
          }
    ...
    addUser(id) {
      ...
      if (!checkMtg.length) {
        ...
        axios
          .post("/api/meetings/attachuser", this.dataHolder)
          .then(response => {
    ...
    removeUsers(id) {
      axios
        .delete("/api/meetings/" + this.meeting.id + "/users/" + id)
        .then(response => {
          let index = this.meeting.users
            .map(function(item) {
              return item.id;
            })
            .indexOf(id);
    ...
    startAgendaEdit(id) {
      ...
      let index = this.meeting.agendas
        .map(function(item) {
          return item.id;
        })
        .indexOf(id);
    ...
    saveAgendaEdit(agendaId) {
      ...
      axios
        .put("/api/agendas/" + this.dataHolder.id, this.dataHolder)
        .then(response => {
          this.meeting.agendas[agendaIndex] = Object.assign(
            {},
            this.dataHolder
          );
          this.dataHolder = {};
    ...
    saveAgendaCreate() {
      axios.post("/api/agendas", this.dataHolder).then(response => {
        this.dataHolder = {};
    ...
    deleteAgenda(agendaId) {
      axios.delete("/api/agendas/" + agendaId).then(() => {
        let agendaindex = this.meeting.agendas
          .map(function(item) {
            return item.id;
          })
    ...
    startFollowupEdit(followupId, agendaId) {
      ...
      let followupindex = this.meeting.agendas[agendaindex].followups
        .map(function(item) {
          return item.id;
        })
        .indexOf(followupId);
      ...
      this.dataHolder = Object.assign(
        {},
        this.meeting.agendas[agendaindex].followups[followupindex]
      );
    },
    saveFollowupEdit(agendaId, followupId) {
      ...
      axios
        .put("/api/followups/" + this.dataHolder.id, this.dataHolder)
        .then(response => {
          this.meeting.agendas[agendaIndex].followups[
            followupIndex
          ] = Object.assign({}, this.dataHolder);
          this.dataHolder = {};
          this.dataItem = "";
        });
    },
    ...
    deleteFollowup(followupId, agendaId) {
      axios.delete("/api/followups/" + followupId).then(response => {
        let agendaindex = this.meeting.agendas
          .map(function(item) {
            return item.id;
          })
    ...
    saveFollowup(agendaId) {
      let agendaIndex = this.meeting.agendas
        ...
        .indexOf(agendaId);
      axios.post("/api/followups", this.dataHolder).then(response => {
        this.dataHolder = {};
    ...
    saveDiscussion(agendaId) {
      let agendaIndex = this.meeting.agendas
        ...
        .indexOf(agendaId);
      axios.post("/api/discussions", this.dataHolder).then(response => {
        this.dataHolder = {};
    ...
    startDiscussionEdit(discussionId, agendaId) {
      ...
      let discussionIndex = this.meeting.agendas[agendaIndex].discussions
        .map(function(item) {
          return item.id;
        })
      ...
      this.dataHolder = Object.assign(
        {},
        this.meeting.agendas[agendaIndex].discussions[discussionIndex]
      );
    },
    ...
    saveDiscussionEdit(agendaId, discussionId) {
      ...
      axios
        .put("/api/discussions/" + this.dataHolder.id, this.dataHolder)
        .then(response => {
          this.meeting.agendas[agendaIndex].discussions[
            discussionIndex
          ] = Object.assign({}, this.dataHolder);
          this.dataHolder = {};
          this.dataItem = "";
    ...
    deleteDiscussion(discussionId, agendaId) {
      axios.delete("api/discussions/" + discussionId).then(response => {
        let agendaIndex = this.meeting.agendas
          .map(function(item) {
            return item.id;
          })
        ...
        this.meeting.agendas[agendaIndex].discussions.splice(
          discussionIndex,
          1
        );
      });
    ...
    saveNoteCreate(meetingId) {
      axios.post("api/notes", this.dataHolder).then(response => {
        this.dataHolder = {};
    ...
    saveNoteEdit() {
      axios
        .put("api/notes/" + this.dataHolder.id, this.dataHolder)
        .then(response => {
