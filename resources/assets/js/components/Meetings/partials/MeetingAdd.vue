...
export default {
  ...
  methods: {
    addNewMeeting() {
      axios.post("/api/meetings", this.meeting).then(response => {
  ...
  computed: {
    ...
    isMeetingComplete() {
      return (
        ...
        this.meeting.secretary_id &&
        this.meeting.chair_id &&
        this.meeting.venue_id &&
        this.meeting.media_id &&
        this.meeting.meetingtype_id &&
        this.meeting.meetingseries_id
      );
    }
  }
};
